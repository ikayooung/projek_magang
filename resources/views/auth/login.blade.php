...
<head>
    ...
    <meta name="description" content="BIRO KLASIFIKASI INDONESIA" />
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="#" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="{{ asset('favicon.png') }}" alt="Logo Politani" width="40px" />
                                </span>
                                <span class="text-capitalize app-brand-text demo text-body fw-bolder">Samarinda</span>
                            </a>
                        </div>
